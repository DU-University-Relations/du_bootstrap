  ...
  Drupal.behaviors.card_list_module = {
      attach: function (context, settings) {
          if (!$('.cards-list-module').hasClass('js-card-list-processed')) {
              once('card_list_module', '.cards-list-module', context).forEach(function (element) {
                  $(element).addClass('js-card-list-processed');
              });
...
(function ($, window, document, undefined) {
    ...
    Drupal.behaviors.buttonHandleClick = {
        attach: function(context, settings) {
            once('handle-button-click', 'button.handle-click', context).forEach(function (element) {
...
(function ($) {
    ...
    Drupal.behaviors.resourcesResetClick = {
        attach: function(context, settings) {
            once('resource-reset-click', '#views-reset-button', context).forEach(function (element) {
                $(element).on('click', function(e) {
                    e.preventDefault();
    ...
    Drupal.behaviors.searchBlockInit = {
        attach: function(context, settings) {
            once('init-search', 'input#site-search-input', context).forEach(function (element) {
    ...
    Drupal.behaviors.initSiteSearchNoResult = {
        attach: function(context, settings) {
            once('init-site-search-no-result', 'input#no-result-site-search-input', context).forEach(function (element) {
                $(element).on('keypress', function(e) {
                    if (e.keyCode == 13 || e.which == 13) {
                        e.preventDefault();
                        var value = $(this).val();
    ...
    Drupal.behaviors.resourceListAutoSubmitInit = {
        attach: function(context, settings) {
            once('first-time-resource', document).forEach(function (element) {
